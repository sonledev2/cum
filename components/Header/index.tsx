    ...
    <div className='border-2 border-b-black'>
      <div className='w-[50%] m-auto py-3 flex justify-between text-[20px]'>
        ...
        <div className='w-[70%] flex items-center justify-between'>
          <button className='w-[70px] px-2 py-1 border-2 border-[#d9dde1] rounded-[6px] hover:bg-[#f3f3f3]'>
          ...
          <div className='w-[70px] px-2 text-center border-2 border-[#d9dde1] rounded-[6px] hover:bg-[#f3f3f3]'>
            <button
              className='flex items-center py-1'
              onClick={() => {
                setOpenVideoModal(!openVideoModal);
